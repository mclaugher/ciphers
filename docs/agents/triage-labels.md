...
Because this repo uses a local-markdown issue tracker, each "label" is the string written into the `Status:` line near the top of an issue file (see `issue-tracker.md`).

| Role in mattpocock/skills | Status string in our tracker | Meaning                                  |
| ------------------------- | ---------------------------- | ---------------------------------------- |
